...
# Only stub nltk and textblob if they are not actually installed/available,
# because some tests depend on their actual behavior.
for _mod in [
    "nltk", "nltk.tokenize", "nltk.tokenize.api", "nltk.corpus",
